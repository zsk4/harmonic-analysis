...
swot_rasters = [f for f in rasters if ("_271_014F" in f.name or "_299_014F" in f.name)]
...
for i in range(N):
    ...
    # Find difference in elevation between nearby points
    # CURRENTLY INCOMPLETE AND UNDECESSARY DUE TO LACK OF DATA [NEED > 32 DATA POINTS!]
    # IMPLEMENTATION WILL FOLLOW ~/ATL11crossover-tides/AmeryRadius.py line 491ish
...
for name_to_plot in ["M2", "S2", "N2", "K2", "K1", "O1", "P1", "Q1"]:
    ...
    fig.savefig(f"{outdir}/{name_to_plot}_271_299_diff.png", dpi=300, bbox_inches="tight", format="png")
    ...
    ax.hist(diff_flat, bins=100, color="gray", edgecolor="gainsboro")
    ...
    ax.set_xlim(-1,1)
    fig.savefig(f"{outdir}/{name_to_plot}_271_299_hist.png", dpi=300, bbox_inches="tight", format="png")
...
for name_to_plot in ["M2", "S2", "N2", "K2", "K1", "O1", "P1", "Q1"]:
    ...
    fig.savefig(f"{outdir}/{name_to_plot}_271_299_fit.png", dpi=300, bbox_inches="tight", format="png")